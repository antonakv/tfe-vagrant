...
openssl genrsa -passout pass:foobar -aes256 -out /vagrant/tfe-vagrant-rootCA-$now.key 4096
openssl req -passin pass:foobar -x509 -new -nodes -key /vagrant/tfe-vagrant-rootCA-$now.key -sha256 -days 3650 -out /vagrant/tfe-vagrant-rootCA-$now.crt -subj "/C=NL/L=AMS/O=HC/CN=192.168.56.33.xip.io"
...
openssl x509 -req -passin pass:foobar -days 3650 -sha256 -in 192.168.56.33.xip.io.csr -CA /vagrant/tfe-vagrant-rootCA-$now.crt -CAkey /vagrant/tfe-vagrant-rootCA-$now.key -CAcreateserial \
...
cp /home/vagrant/192.168.56.33.xip.io.crt /home/vagrant/server.crt
cp /home/vagrant/192.168.56.33.xip.io.key /home/vagrant/server.key
